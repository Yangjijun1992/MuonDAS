...
_DEFAULTS: Dict[str, Any] = {
    ...
    "signal_id": {
        # Width-cut discrimination: narrow (prompt-like) -> S1, wide
        # (delayed-like) -> S2.  Optional gates (None disables):
    ...
    "plotting": {
        "backend": "Agg",
        "dynode_scale": 113,   # anode:dynode area slope ~113 (LED calibration)
